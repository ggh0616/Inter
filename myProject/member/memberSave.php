...
include "../include/dbConnect.php";
 ...
 //닉네임, 생일 그리고 이름이 빈값이 아닌지, ||는 또는
 if ($memberNickName == '' || $memberBirthDay == '' || $memberName == '') {
     echo '생일 혹은 닉네임의 값이 없습니다.';
     exit;
 }

 //이메일 주소가 올바른지
 $checkEmailAddress = filter_var($memberEmailAddress, FILTER_VALIDATE_EMAIL); //filter_var()는 입력받은 이메일 주소가 형식에 맞게 입력했는지 확인하는 함수
